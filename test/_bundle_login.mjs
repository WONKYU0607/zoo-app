...
var init_ads = __esm({
  "src/lib/ads.js"() {
    ...
    AD_REWARD_ID = typeof import.meta !== "undefined" && import.meta.env && import.meta.env.VITE_AD_REWARD_ID || TEST_REWARD_ID;
    AD_IS_TEST = AD_REWARD_ID === TEST_REWARD_ID;
    TEST_INTER_ID = "ca-app-pub-3940256099942544/1033173712";
    AD_INTER_ID = typeof import.meta !== "undefined" && import.meta.env && import.meta.env.VITE_AD_INTER_ID || TEST_INTER_ID;
    inited = false;
    showing = false;
    adBusy = () => showing;
  }
...
function mount(root) {
  ...
  function paintGate() {
    ...
    const st = document2.getElementById("start");
